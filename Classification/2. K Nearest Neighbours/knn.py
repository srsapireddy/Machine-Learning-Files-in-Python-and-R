...
# To choose the Euclidean Distance we first choose metric = minkowski and we need to choose P = 2 (Power Parameter for the Minkowski Metric) when P = 1 this is equavilant to using Manhatten Distance.
